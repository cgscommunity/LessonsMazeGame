...
Level::~Level()
{
	...
	//discuss ownership and possible shared pointer access
...
{
	//instantion 
	//perhaps a legend to map the values
	...
	for (int y = 0; y < m_height; ++y)
	{
		for (int x = 0; x < m_width; ++x)
		{
			...
			case 'b':
				...
				break;
				//dry store look up table with ascii fields and 
			case 'R':
				m_pLevelData[index] = ' ';
...
//doing too much, update should just update
// but how to avoid multiple for looops for collisions
// not clear what x & y represent
